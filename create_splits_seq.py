...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal', 'task_2_tumor_subtyping', 'camelyon'])
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes = 2
    dataset = Generic_WSI_Classification_Dataset(csv_path = "dataset_csv/camelyon.csv",
                                                shuffle = False,
                                                seed = args.seed,
                                                print_info = True,
...
test_num = 129
val_num = np.round((num_slides_cls - test_num) * args.val_frac).astype(int)
custom_test_ids = range(0, 129)
